    ...
    <div className="container">
      ...
      <div className="map-wrapper">
        <MapContainer key={`${center[0]},${center[1]}`} className="user-map">
          <TileLayer
            {...{
              url: `https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoic3p5bW9ucGciLCJhIjoiY21rOGdjeHdmMWJyejNlcXh3NjZqazRnMSJ9.GWQyE5PLG-GGFzn5GQLPyg`,
              attribution:
