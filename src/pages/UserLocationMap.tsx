    ...
    <div className="container">
      ...
      <div className="map-wrapper">
        <MapContainer key={`${center[0]},${center[1]}`} className="user-map">
          <TileLayer
            {...{
              url: `https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoic3p5bW9ucGciLCJhIjoiY21rOW11aGYyMWplbjNjcXhjcTVsYWkyMyJ9.bE390oOF2171bxAta_2smQ`,
              attribution:
